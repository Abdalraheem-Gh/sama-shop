...
const AdminOverviewPage =async () => {
    ...
    return ( <div className="space-y-2">
        ...
        <Card>
                ...
                <CardContent>
                    <div className="text-2xl font-bold">
                        {formatCurrency(String(summary.totalSales._sum.totalPrice!))}
                    </div>
                </CardContent>
            </Card>
            <Card>
        ...
        <div className="grid gap-5 lg:grid-cols-7 md:grid-cols-2 grid-cols-1">
                        ...
                        <TableBody>
                            {summary.latestSales.map((order)=>(
                                <TableRow key={order.id}>
                                    ...
                                    <TableCell><Link href={`/order/${order.id}`}>
                                        <span className="px-2">
                                        Details
                                        </span>
                                        </Link></TableCell>
